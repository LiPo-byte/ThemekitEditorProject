...
/**
 * 锁屏健康组件（type 1009 / layoutType 0 / 圆形）。
 * 结构参照 rule_ymal/resource-validation/lock_screen_health_layout_0_size_0.yml：
 * yml 只约束 size / name / layoutType，没有任何文本字段，
 * 所以下面的步数是写死的预览值，画布上不可编辑。
 */

const ICON_SIZE_WIDTH = 60 / LOCK_ASSET_SCALE;
const ICON_SIZE_HEIGHT = 69 / LOCK_ASSET_SCALE;
const CONTENT_GAP = 2;

/** 画布上的示例步数，仅用于预览，不进配置 */
const PREVIEW_STEPS = '-50000';

export default function LockHealthCircle_0(props: any) {
